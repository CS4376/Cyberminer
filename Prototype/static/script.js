document.getElementById("search-form").addEventListener("submit", function (event) {
  ...
  const data = { keyword, count, min_year: minYear, expiry_date: expiryDate, all_results: allResults };
  ...
  fetchSearchResults(keyword, count, minYear, expiryDate, allResults, sortOrder, 1); // include sortOrder
});

// Function to fetch search results for a given page
function fetchSearchResults(keyword, count, minYear, expiryDate, allResults, sortOrder, page) {
  const data = { keyword, count, min_year: minYear, expiry_date: expiryDate, all_results: allResults, sortOrder, page };
